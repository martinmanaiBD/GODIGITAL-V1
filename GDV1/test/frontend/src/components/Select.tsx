...
interface SelectProps
  ...
  onChange?: any; // Add this line
  getOptionValue?: any; // Add this line
}
...
const Select: React.FC<SelectProps> = ({
  ...
  label,
  errorText,
  name: nameProp, // Add this line
  onChange, // Add this line
  getOptionValue, // Add this line
  ...props
}) => {
  ...
  return (
    <Box {...spacingProps}>
      ...
      <ReactSelect
        ...
        getOptionValue={getOptionValue} // Add this line
        value={props.value}
        // {...props}
      />
      {errorText && (
